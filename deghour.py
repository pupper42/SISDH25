...
#Hours since 1st Jan
veraison_start = 2196 #start of 15th Feb
veraison_end = 5076 #approximately end of 15th April (start of 16th)
...
final_file = save_dir + "station_dh25_30min.csv"
print(final_file)
